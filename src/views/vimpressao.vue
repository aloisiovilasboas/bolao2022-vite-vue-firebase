<template >
    ...
    <table style="background:white; color:#0f253f">
        <tbody>
            <tr>
                ...
                <td id="sites-canvas-wrapper">
                    <div id="sites-canvas" role="main">
                        ...
                        <h3 xmlns="http://www.w3.org/1999/xhtml" id="sites-page-title-header"  align="left">
                            <span id="sites-page-title" dir="ltr" tabindex="-1" style="outline: none">Jorge Vilas
                                Boas</span>
                        </h3>
                        <div id="sites-canvas-main">
                            <div id="sites-canvas-main-content">
                                <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0">
                                    <tbody style="background:white; color:#0f253f">
                                        <tr>
                                            <td class="sites-layout-tile sites-tile-name-content-1">
                                                <div dir="ltr">
                                                    <div>
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            style="font-family:System,sans-serif; width:100%;margin-left:2.8pt;border-collapse:collapse"
                                                            width="100%">
                                                            <tbody>
                                                                <tr style="height:19.1pt">
                                                                    <td colspan="5"
                                                                        style="text-align:center;border:1pt solid black;background:#0f253f;padding:0cm 3.5pt;height:15pt">
                                                                        <b><span
                                                                                style="font-size:15pt;font-family:Candara,sans-serif;color:#ffffff">Grupo
                                                                                A</span></b>
                                                                    </td>
                                                                ...
                                                                <tr style="height:15pt">
                                                                    ...
                                                                    <td style="font-size:12pt;text-align:center;width:8.85pt;;border-width:medium medium 1pt medium;border-style:none none solid none;padding:0cm 3.5pt;height:15pt"
                                                                        width="12">
                                                                        x
                                                                    </td>
                                                                    <td style="font-size:12pt;text-align:center;width:10pt;;border-width:medium medium 1pt medium;border-style:none none solid none;padding:0cm 3.5pt;height:15pt"
                                                        ...
                                                        <br>
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            style="font-size:12pt;text-align:center;font-family:System,sans-serif;width:93.9%;margin-left:2.8pt;border-collapse:collapse">
                                                            <tbody>
                                                                <tr style="width:100%">
                                                                    <td colspan="8"
                                                                        style="border:1pt solid black;background:#0f253f;padding:0cm 3.5pt"
                                                                        width="100%">
                                                                        <p align="center"
                                                                            style="margin-bottom:0.0001pt;text-align:center;line-height:normal">
                                                                            <b>
                                                                                <span
                                                                                    style="font-size:14pt;font-family:Candara,sans-serif;color:#ffffff">
                                                                                    Oitavas de Final</span></b>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td
                                                                        style=";border-width:1pt;border-style:solid;border-color:-moz-use-text-color -moz-use-text-color -moz-use-text-color black;padding:0cm 3.5pt;height:30pt">
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        style="width:12.5%;;border-width:1pt;border-style:solid;border-color:-moz-use-text-color -moz-use-text-color -moz-use-text-color black;padding:0cm 3.5pt;height:30pt">
                                                                    ...
                                                                    <td colspan="12"
                                                                        ...
                                                                        <p align="center"
                                                                            ...
                                                                            <b>
                                                                                <span
                                                                                    style="font-size:14pt;font-family:Candara,sans-serif;color:#ffffff">
                                                                                    Quartas de Final</span></b>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td
                                                                        style="width:25%;;border-width:1pt;border-style:solid;border-color:-moz-use-text-color -moz-use-text-color -moz-use-text-color black;padding:0cm 3.5pt;height:14.1pt">
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        style="width:50%;;border-width:1pt;border-style:solid;border-color:-moz-use-text-color -moz-use-text-color -moz-use-text-color black;padding:0cm 3.5pt;height:14.1pt;text-align:center">
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        style="width:50%;;border-width:1pt;border-style:solid;border-color:-moz-use-text-color -moz-use-text-color -moz-use-text-color black;padding:0cm 3.5pt;height:24.2pt">
                                                        ...
                                                        <br>
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            style="font-size:16pt;text-align:center;font-family:System,sans-serif;width:93.9%;margin-left:2.8pt;border-collapse:collapse"
                                                            width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td colspan="12"
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        style="width:100%;;border-width:1pt;border-style:solid;border-color:-moz-use-text-color -moz-use-text-color -moz-use-text-color black;padding:0cm 3.5pt;height:30pt">
                                ...
                                <div class="agenda__game__container">
                                    ...
                                    <div class="agenda__game__info2 col-4">
                                        <RadioButton inputId=jogo.inputidhome name=jogo.matchNumber value=home
                                            :disabled="true" @change="updatePartidaMatamata(jogo, tab.fase)"
                                            v-model="jogo.winner" />
                                        <div>X</div>
